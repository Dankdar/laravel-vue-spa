<template>
  <div class="min-h-screen flex flex-col justify-center items-center pt-6 sm:pt-0 p-4">
    ...
    <div class="w-full sm:max-w-md mt-6 px-6 py-4 bg-white shadow-md overflow-hidden rounded-lg">
      <form @submit.prevent="login">
        ...
        <div class="flex items-center justify-end mt-4">
          <router-link class="underline text-sm text-gray-500 hover:text-rosd-500" :to="{name: 'ForgotPassword'}">
    ...
    <div class="text-center text-sm mt-4">
        ...
        <router-link class="underline text-gray-200 hover:text-rose-500" :to="{name: 'Register'}">
          Sign up now
        </router-link>
    </div>
  </div>
